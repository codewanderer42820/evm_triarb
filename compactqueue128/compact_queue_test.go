...
// ============================================================================
//
// Comprehensive test coverage for CompactQueue128 operations with
...
func TestPushAndPeepMin(t *testing.T) {
	...
	// Test edge cases: boundary tick values (0 and 127 for CompactQueue128)
...
func TestPoolBoundaryAccess(t *testing.T) {
	...
	for _, h := range testHandles {
		...
		tick := int64(h) % int64(BucketCount)
